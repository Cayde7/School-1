...
# FUTURE: animate the logo with some kind of pulse animation to grab people's attention
...
def input_screen():
    ...
    MainWindow.rowconfigure(2, weight=0)
    # after 2 minutes of inactivity, the window will switch to the welcome screen
    MainWindow.after(120000, lambda: welcome_screen())
...
def post_tweet(naam, tweet):
    ...
    if len(tweet) > 140:
        ...
        TA.add_tweet(naam, tweet, station)
        welcome_screen()
        return True

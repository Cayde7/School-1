...
def standaardprijs(afstandKM):
    ...
    return 0.0                              # afstand is kleiner dan 0 dus return 0 euro, 0.0 is ingevoerd omdat
                                            # de output een float moet zijn volgens de opdracht


def ritprijs(leeftijd, weekendrit, afstandKM):

    stprijs = standaardprijs(afstandKM)      #scheelt herhaling
...
# 2 missende cases waren: case(65, True, -51, 0.0), case(65, False, -51, 0.0) en zijn toegevoegd
...
"""
==========================[ Eigen input ]================================
Hieronder staat een stuk code dat toegang geeft tot eigen input.
"""
